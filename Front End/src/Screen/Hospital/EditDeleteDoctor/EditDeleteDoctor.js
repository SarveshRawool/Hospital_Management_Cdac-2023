...
function EditDeleteDoctor() {
    const Home=()=>{
      ...
      const id= window.sessionStorage.getItem("dId");
...
const uploadImage=(event)=>{
    ...
    var helper=new XMLHttpRequest;
          helper.onreadystatechange=()=>{
              if(helper.readyState==4&&helper.status==202){
                toast.error("Doctor removed Successfully!!!", {
                  position: "top-center",
                  autoClose: 1000,
                  hideProgressBar: false,
                  closeOnClick: true,
  ...
  <center>
          <div style={{width:600}}>
                  ...
                  <h1 class="h3 mb-3 fw-normal">Want to Remove this Doctor?</h1>
